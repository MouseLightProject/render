...
ssh login1 "source /misc/lsf/conf/profile.lsf; ${RENDER_PATH}/src/render/src/projection ${RENDER_PATH}/src/render/test/hollowcube/projection-coronal-cluster-parameters.jl" &
${RENDER_PATH}/src/render/src/projection ${RENDER_PATH}/src/render/test/hollowcube/projection-coronal-local-parameters.jl
