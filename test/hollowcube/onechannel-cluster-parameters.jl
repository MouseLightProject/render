...
const destination=joinpath(source,"scratch","onechannel-cluster","results")  # path to octree

const shared_scratch=joinpath(source,"scratch","onechannel-cluster","shared_scratch")
const logfile_scratch=joinpath(source,"scratch","onechannel-cluster","logfile_scratch")  # should be on /groups
