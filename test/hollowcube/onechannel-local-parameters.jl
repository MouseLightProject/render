...
const destination=joinpath(source,"scratch","onechannel-local","results")  # path to octree

const shared_scratch=joinpath(source,"scratch","onechannel-local","shared_scratch")
const logfile_scratch=joinpath(source,"scratch","onechannel-local","logfile_scratch")  # should be on /groups
