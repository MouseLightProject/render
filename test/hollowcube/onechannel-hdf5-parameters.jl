...
const destination=joinpath(scratchpath,"onechannel-hdf5","results")  # path to octree

const file_infix="hollowcube"
const file_format_load="tif"  # "tif" or "h5"
const file_format_save="h5"  # "tif" or "h5"

const local_scratch=joinpath(scratchpath,"onechannel-hdf5","local_scratch")
const shared_scratch=joinpath(scratchpath,"onechannel-hdf5","shared_scratch")
const logfile_scratch=joinpath(scratchpath,"onechannel-hdf5","logfile_scratch")  # should be on /groups
