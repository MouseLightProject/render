...
const destination=joinpath(source,"scratch","linearinterp","results")  # path to octree

const shared_scratch=joinpath(source,"scratch","linearinterp","shared_scratch")
const logfile_scratch=joinpath(source,"scratch","linearinterp","logfile_scratch")  # should be on /groups
