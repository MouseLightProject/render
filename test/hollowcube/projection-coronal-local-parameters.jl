...
const frompath = ENV["RENDER_PATH"]*"/src/render/test/hollowcube/scratch/threechannel-local/results"  # the octree output of src/render
const topath = ENV["RENDER_PATH"]*"/src/render/test/hollowcube/scratch/projection-coronal-local"
...
const which_cluster = ["arthurb-ws2"]  # "janelia" or ["hostname1", "hostname2", "hostname3", ...]
