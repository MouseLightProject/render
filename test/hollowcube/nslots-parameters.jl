...
const destination=joinpath(source,"scratch","nslots","results")  # path to octree

const shared_scratch=joinpath(source,"scratch","nslots","shared_scratch")
const logfile_scratch=joinpath(source,"scratch","nslots","logfile_scratch")  # should be on /groups
