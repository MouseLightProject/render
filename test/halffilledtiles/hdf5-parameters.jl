...
const destination=joinpath(source,"scratch","hdf5","results")  # path to octree

const file_infix="halffilledcube"
const file_format_load="tif"  # "tif" or "h5"
const file_format_save="h5"  # "tif" or "h5"

const shared_scratch=joinpath(source,"scratch","hdf5","shared_scratch")
const logfile_scratch=joinpath(source,"scratch","hdf5","logfile_scratch")  # should be on /groups
