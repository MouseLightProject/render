...
const local_scratch=joinpath(scratch_path,"cpu","local_scratch")
const shared_scratch=joinpath(scratch_path,"cpu","shared_scratch")
const logfile_scratch=joinpath(scratch_path,"cpu","logfile_scratch")  # should be on /groups
